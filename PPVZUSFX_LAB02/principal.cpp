...
int main() {
	...
	cout << "La posicion X del zombie es: " << Rosita->getPosicionX() << endl;
	cout << "La posicion Y del zombie es: " << Rosita->getPosicionY() << endl;
	ZombieDeportista* Messi = new ZombieDeportista("Messi");
	//Messi.setNombre("Messi");
	cout << "El nombre del zombie es :" << Messi->getNombre() << endl;
	cout << "La energia del zombie es: " << Messi->getEnergia() << endl;
	cout << "La velocidad del zombie es: " << Messi->getVelocidad() << endl;
	cout << "La posicion X del zombie es: " << Messi->getPosicionX() << endl;
	cout << "La posicion Y del zombie es: " << Messi->getPosicionY() << endl;
	Messi->correr();
	cout << "La posicion X del zombie despues de correr aleatoriamente es: " << Messi->getPosicionX() << endl;
	Messi->saltar();
	cout << "La posicion Y del zombie despues de su salto es: " << Messi->getPosicionY() << endl;
	return 0;
}